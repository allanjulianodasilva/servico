...
<body>
    ...
    <form action="processar_alteracao.php" method="POST">
     numero_identificacao: <input type="text" name="nome" value="<?php echo $numero_identificacao ?>" required><br>
     data_solicitacao: <input type="text" name="cpf" value="<?php echo  $data_solicitacao ?>" ><br>
     data_inicio: <input type="text" name="endereco" value="<?php echo $data_inicio  ?>" required><br><br>
     data_termino: <input type="text" name="telefone" value="<?php echo $data_termino  ?>" ><br>
     cliente: <input type="text" name="telefone" value="<?php echo $cliente ?>" ><br>
     <select cliente="servico">
     tecnico: <input type="text" name="telefone" value="<?php echo $tecnico  ?>" ><br>
     <select tecnico="servico">
     atentente: <input type="text" name="telefone" value="<?php echo $atentente ?>" ><br>
